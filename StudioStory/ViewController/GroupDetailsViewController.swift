...
class GroupDetailsViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UIGestureRecognizerDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        photoViewModel.fetchPickedPhoto(groupName: title) { (viewModel) in
            if let viewModel = viewModel, let image = viewModel.image {
                self.pictures.append(image)
            }
            self.photoViewModels.append(viewModel!)
...
extension GroupDetailsViewController: UIViewControllerPreviewingDelegate {
...
extension GroupDetailsViewController: PhotoStoryLayoutDelegate {
