...
extension UIImage {
    ...
    public func getColors(quality: UIImageColorsQuality = .high, _ completion: @escaping ([UIColor]) -> Void) {
    ...
    public func getColors(quality: UIImageColorsQuality = .high) -> [UIColor] { //UIImageColors {
